...
const AboutTeam = () => {
  ...
  return (
    <>
      <Box sx={{ paddingBottom: "3%", paddingTop: "70px" }}>
        <Container
          maxWidth={"xl"}
          ...
          >
            <Grid item xs={12}>
              ...
              >
                ...
                >
                  We created CredMudra with the conviction that action is the
                  key to achieving financial freedom and success. The same way
                  we created Team Credmudra and named it Mudra Mentors.
                </Typography>
              </Box>
            </Grid>
          </Grid>
